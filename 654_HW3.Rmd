...
#Logistic Regression with Ridge Penalty also performed better than the Bagges Trees
...
#RL note: the following I used in my cross 10 fold cross validation in Part 1.
#Haven't tried this for Part 2
